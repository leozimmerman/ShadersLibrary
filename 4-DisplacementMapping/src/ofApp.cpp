...
//    logoImage.load("of.png");
    ...
    colormap.mirror(true, false);
    bumpmap.load("earth-bumps.jpg");
    bumpmap.mirror(true, false);
    
    
//
    shaderManager.load("displacePhong");
    ...
    shaderManager.setTexture(&colormap);
    shaderManager.setBumpMapTexture(&bumpmap);
    ...
    sphere.mapTexCoordsFromTexture(colormap.getTexture());
    
    box.set(850);
    box.mapTexCoordsFromTexture(colormap.getTexture());
    
    cylinder.set(70, 150);
    cylinder.mapTexCoordsFromTexture(colormap.getTexture());
...
void ofApp::draw(){
    ...
    shaderManager.setMaxHeight(mouseX);
...
//    shaderManager.toggleTexture(&colormap);
}
